# HNSW-RaBitQ 索引 (/zh/docs/db/concepts/vector-index/hnsw-rabitq-index)
...
<Callout className="text-base" type="info">
  **平台要求**：HNSW-RaBitQ 目前仅支持 **Linux x86\_64**，CPU 需要支持 **AVX2 或 AVX512**。Zvec 会自动选择最佳运行时。
</Callout>
...
* ✅ 运行在支持 AVX2 或 AVX512 的 **Linux x86\_64** 服务器上的工作负载
