# 单向量 (/zh/docs/db/data-operations/query/single-vector)
...
<Callout className="text-base" type="info">
  ...
  <Cards>
    <Card title="HNSW 查询参数" href="../../../concepts/vector-index/hnsw-index/#索引查询参数" icon="<Settings2 className=&#x22;text-purple-300&#x22; />" />

    <Card title="HNSW-RaBitQ 查询参数" href="../../../concepts/vector-index/hnsw-rabitq-index/#索引查询参数" icon="<Settings2 className=&#x22;text-purple-300&#x22; />" />

    <Card title="IVF 查询参数" href="../../../concepts/vector-index/ivf-index/#索引查询参数" icon="<Settings2 className=&#x22;text-purple-300&#x22; />" />

    <Card title="IVF-RaBitQ 查询参数" href="../../../concepts/vector-index/ivf-rabitq-index/#索引查询参数" icon="<Settings2 className=&#x22;text-purple-300&#x22; />" />

    <Card title="DiskANN 查询参数" href="../../../concepts/vector-index/diskann-index/#索引查询参数" icon="<Settings2 className=&#x22;text-purple-300&#x22; />" />
  </Cards>
</Callout>
...
<Accordions type="multiple">
  ...
  <Accordion title="IVF-RaBitQ 索引示例" id="ivf-rabitq-example">
    如果 `dense_embedding` 使用 [IVF-RaBitQ](../../../concepts/vector-index/ivf-rabitq-index/) 索引，你可以通过 `nprobe` 调节扫描的倒排列表数：
        ...
        result = collection.query(  # [!code highlight]
            queries=zvec.Query(
                ...
                param=zvec.IvfRabitqQueryParam(
                    nprobe=100,  # 扫描更多列表通常能提高 Recall [!code highlight]
