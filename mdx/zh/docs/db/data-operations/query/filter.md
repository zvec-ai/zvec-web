# 条件过滤 (/zh/docs/db/data-operations/query/filter)
...
| 运算符    | 描述         | 支持的数据类型 | 示例表达式                                                            | 说明                                                                                                                             |
| ------ | ---------- | ------- | ---------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| `like` | 使用通配符的模式匹配 | 字符串     | • `product_name like 'Smart%'` <br /> • `file_name like '%.log'` | • `'Smart%'`：匹配以 'Smart' 开头的值（例如 'SmartPhone'、'SmartWatch'） <br /> • `'%.log'`：匹配以 '.log' 结尾的值（例如 'app.log'、'debug\_2025.log'） |
