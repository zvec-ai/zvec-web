# Benchmark (/zh/docs/zvec-grep/benchmarks)
...
<div className="not-prose my-6">
  <img className="block w-full dark:hidden" src="/img/docs/zvec-grep/benchmarks/benchmark-overall-retrieval-indexed-v4-light.svg" alt="Zvec-Grep 在代码与通用文本检索场景中的 Benchmark 对比" />

  <img className="hidden w-full dark:block" src="/img/docs/zvec-grep/benchmarks/benchmark-overall-retrieval-indexed-v4-dark.svg" alt="Zvec-Grep 在代码与通用文本检索场景中的 Benchmark 对比" />
</div>
