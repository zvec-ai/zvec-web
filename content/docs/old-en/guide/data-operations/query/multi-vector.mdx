...
<Accordions type="single">
  ...
  collection_schema = db.CollectionSchema(  # [!code highlight]
      ...
      fields=[
          FieldSchema(name="publish_year", data_type=DataType.INT64),
          FieldSchema(name="category", data_type=DataType.ARRAY_STRING),
      ],
  )
...
<Accordions type="single">
  ...
  result = collection.query(      # [!code highlight]
      ...
      reranker=WeightedReRanker(  # [!code highlight]
          ...
          metric=MetricType.IP,  # Metric used to interpret raw scores
