...
<Accordions type="single">
  ...
  from zvec import FieldSchema, VectorSchema, db
  from zvec.model.param import HnswIndexParam, InvertIndexParam
...
<Accordions type="single">
  ...
  results = collection.query(
      filter="category CONTAIN_ALL('science', 'philosophy')", topk=10
  )
