...
**Zvec** is an open-source, fast, lightweight, and feature-rich vector database that runs entirely **in-process** — no server, daemon, or external infrastructure required. Simply [install](./quickstart/) it as a Python package and start indexing and querying vectors right away 🚀.
