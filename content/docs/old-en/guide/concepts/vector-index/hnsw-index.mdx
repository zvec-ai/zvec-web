...
| `scale_factor` | Controls **the number of candidates sent to refinement** (multiplied by `topk`). | • Higher `scale_factor` → <br /> ✨ better ranking quality (more candidates re-scored) <br /> ⚠️ Higher latency |
