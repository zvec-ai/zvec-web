...
=======
- Include only the fields and vectors you **intend to update**, formatted according to the collection's [schema](../../collections/create/schema/#define-a-collection-schema):
...
```python tab="Python" title="Update a batch of documents"
import zvec
