---
title: Quickstart
description: Get started with Zvec in minutes — create a collection, insert documents with vector embeddings, and run your first similarity search.
icon: Rocket
---
...
# Requires 64-bit Python 3.9-3.14 (32-bit interpreters are not supported)
pip install zvec
```
...
```python tab="Python" title="Create a collection" tab-group="code-demo"
import zvec
...
```python tab="Python" title="Insert a document" tab-group="code-demo"
# [!code word:embedding]
# [!code word:publish_year]
...
```python tab="Python" title="Fetch a document" tab-group="code-demo"
...
```python tab="Python" title="Basic similarity search" tab-group="code-demo"
# [!code word:embedding]
...
```python tab="Python" title="Filtered similarity search" tab-group="code-demo"
# [!code word:embedding]
result = collection.query(        # [!code highlight]
    queries=zvec.Query(
        field_name="embedding",
...
```python tab="Python" title="View collection schema" tab-group="code-demo"
# [!code word:schema]
...
```python tab="Python" title="View collection statistics" tab-group="code-demo"
# [!code word:stats]
...
```python tab="Python" title="Delete a document" tab-group="code-demo"
# [!code word:delete]
...
```python tab="Python" title="Delete documents by filter condition" tab-group="code-demo"
