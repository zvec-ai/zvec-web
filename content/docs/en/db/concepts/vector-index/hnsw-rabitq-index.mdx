...
<Callout className="text-base" type="info">
  **Platform requirement**: HNSW-RaBitQ currently supports **Linux x86_64** only. The CPU must support **AVX2 or AVX512**. Zvec automatically selects the best runtime.
</Callout>
...
- ✅ Workloads on **Linux x86_64** servers with AVX2 or AVX512 support
