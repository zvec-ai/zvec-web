---
title: Vector Index
description: Specialized data structures that accelerate similarity search — trading a small amount of recall for massive gains in speed and scalability.
---
...
1. [IVF-RaBitQ (IVF with RaBitQ Quantization)](./ivf-rabitq-index/)
