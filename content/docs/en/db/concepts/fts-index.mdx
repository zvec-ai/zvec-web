...
Tokenizers determine how text is split into terms, directly affecting retrieval quality. The same tokenizer configuration is used for both indexing and querying. For tokenizer configuration details, see the [full-text search guide](../data-operations/query/fts/#tokenizers).
