---
title: Data Modeling
description: How Zvec organizes data with collections, documents, schemas, and indexes.
---
...
1. **Vector types** — dense or sparse numeric representations for vector embeddings
