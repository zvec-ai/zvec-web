...
1. **Collection options** (optional) — runtime settings that control how the collection behaves when opened (e.g., read-only mode).
...
```python tab="Python" title="Create and open a collection" tab-group="code-demo"
import zvec
