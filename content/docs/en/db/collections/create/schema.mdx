...
<Callout className="text-base" type="info">
  HNSW-RaBitQ is available only on **Linux x86_64** with AVX2 or AVX512 support. Zvec automatically selects the best runtime.
</Callout>
...
<Callout className="text-base" type="info">
  IVF-RaBitQ is available only on **Linux x86_64** with AVX2 or AVX512 support. Zvec automatically selects the best runtime.
</Callout>
