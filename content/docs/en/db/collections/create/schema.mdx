...
Use [`DiskAnnIndexParam()`](../../../concepts/vector-index/diskann-index/#index-time-parameters) for DiskANN index configuration. This index is designed for billion-scale datasets that exceed available memory.
