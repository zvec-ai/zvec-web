...
nodejsApiReference: /api-reference/nodejs/interfaces/ZVecCollection
---
...
```python tab="Python" title="Add a column" tab-group="code-demo"
import zvec
...
```ts tab="Node.js" title="Add a column"
...
```python tab="Python" title="Drop a column" tab-group="code-demo"
# [!code word:drop_column]
collection.drop_column(field_name="publish_year")
```

```ts tab="Node.js" title="Drop a column"
...
```python tab="Python" title="Alter a column" tab-group="code-demo"
# Rename
...
```ts tab="Node.js" title="Alter a column"
// Rename
...
```python tab="Python" title="View the current schema" tab-group="code-demo"
print(collection.schema)
```

```ts tab="Node.js" title="View the current schema"
...
```python tab="Python" title="Create an index" tab-group="code-demo"
import zvec
...
```ts tab="Node.js" title="Create an index"
// Replace the existing HNSW index with a FLAT index
...
```python tab="Python" title="Drop an index" tab-group="code-demo"
# [!code word:drop_index]
collection.drop_index(field_name="publish_year")
```

```ts tab="Node.js" title="Drop an index"
