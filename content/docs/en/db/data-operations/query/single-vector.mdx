...
<Callout className="text-base" type="info">
  ...
  <Cards>
    ...
    />
    <Card
      title="IVF-RaBitQ Query Parameters"
      href="../../../concepts/vector-index/ivf-rabitq-index/#query-time-parameters"
      icon={<Settings2 className="text-purple-300" />}
    />
    <Card
      title="DiskANN Query Parameters"
      href="../../../concepts/vector-index/diskann-index/#query-time-parameters"
      icon={<Settings2 className="text-purple-300" />}
    />
  </Cards>
