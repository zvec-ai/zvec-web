...
To run a multi-vector search, pass a list of [vector query specification](../#query) to the `query()` method and specify a fusion strategy via the `reranker` parameter.
