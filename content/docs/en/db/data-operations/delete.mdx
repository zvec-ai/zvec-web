...
nodejsApiReference: /api-reference/nodejs/interfaces/ZVecCollection#deletesync
---
...
```python tab="Python" title="Delete documents by IDs" tab-group="code-demo"
...
```ts tab="Node.js" title="Delete documents by IDs"
// Delete a single document
