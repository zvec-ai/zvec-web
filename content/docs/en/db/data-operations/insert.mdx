...
nodejsApiReference: /api-reference/nodejs/interfaces/ZVecCollection#insertsync
---
...
```python tab="Python" title="Insert a batch of documents" tab-group="code-demo"
import zvec
...
```python tab="Python" title="Insert a document with a sparse vector" tab-group="code-demo"
import zvec
...
```python tab="Python" title="Insert a document with multiple fields and vectors" tab-group="code-demo"
import zvec
