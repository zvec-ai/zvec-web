...
nodejsApiReference: /api-reference/nodejs/interfaces/ZVecCollection#fetchsync
---
...
```python tab="Python" title="Fetch documents" tab-group="code-demo"
# [!code word:fetch]
...
```ts tab="Node.js" title="Fetch documents"
// [!code word:fetchSync]
// Fetch a single document
