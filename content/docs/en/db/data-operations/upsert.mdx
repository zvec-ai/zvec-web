...
nodejsApiReference: /api-reference/nodejs/interfaces/ZVecCollection#upsertsync
---
...
```python tab="Python" title="Upsert a document" tab-group="code-demo"
import zvec
...
```ts tab="Node.js" title="Upsert a document"
...
```python tab="Python" title="Upsert a batch of documents" tab-group="code-demo"
import zvec
...
```python tab="Python" title="Upsert a document with a sparse vector" tab-group="code-demo"
import zvec
...
```python tab="Python" title="Upsert a document with multiple fields and vectors" tab-group="code-demo"
import zvec
