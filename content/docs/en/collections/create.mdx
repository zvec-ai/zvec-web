...
<Accordion title="HNSW Index Example">
...
<Accordion title="HNSW-RaBitQ Index Example">
...
```ts tab="Node.js" title="Define a vector embedding"
import { ZVecDataType, ZVecIndexType, ZVecMetricType, ZVecVectorSchema } from "./src/index";
...
<Accordion title="IVF Index Example">
