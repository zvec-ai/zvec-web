...
- [Dense Embedding Function Protocol](/api-reference/extension/#zvec.extension.DenseEmbeddingFunction)
- [Sparse Embedding Function Protocol](/api-reference/extension/#zvec.extension.SparseEmbeddingFunction)
- [Sentence Transformers Base Class](/api-reference/extension/#zvec.extension.SentenceTransformerFunctionBase)
- [Qwen Function Base Class](/api-reference/extension/#zvec.extension.QwenFunctionBase)
- [Openai Function Base Class](/api-reference/extension/#zvec.extension.OpenAIFunctionBase)
