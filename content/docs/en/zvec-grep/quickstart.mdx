---
title: Quickstart
description: Build a sample index, then search it from an AI agent or the terminal.
icon: Rocket
---
...
<details>
<summary><strong>Example Agent result</strong></summary>
