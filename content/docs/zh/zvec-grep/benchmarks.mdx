...
| 通用文本 · BrowseComp-Plus | **维持 90%** | **−41.7%** | **−37.3%** | **−30.0%** |

代码评测包含 11 个仓库中的 20 个任务，每组配置运行三次；通用文本评测包含 100,195 篇文档上的 80 个样例，每组配置运行两次。

<img
  src="https://raw.githubusercontent.com/zvec-ai/zvec-grep/main/.github/assets/benchmark-overall-retrieval-indexed-v3.png"
