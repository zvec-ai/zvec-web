...
```python tab="Python" title="Upsert Document" tab-group="code-demo"
import zvec
...
```ts tab="Node.js" title="Upsert Document"
...
```python tab="Python" title="批量 Upsert Document" tab-group="code-demo"
import zvec
...
```python tab="Python" title="Upsert 包含稀疏向量的 Document" tab-group="code-demo"
import zvec
...
```python tab="Python" title="Upsert 包含多个字段和向量的 Document" tab-group="code-demo"
import zvec
