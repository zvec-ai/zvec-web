...
```python tab="Python" title="批量插入 Document" tab-group="code-demo"
import zvec
...
```python tab="Python" title="插入包含稀疏向量的 Document" tab-group="code-demo"
import zvec
...
```python tab="Python" title="插入包含多个字段和向量的 Document" tab-group="code-demo"
import zvec
