...
```python tab="Python" title="添加列" tab-group="code-demo"
import zvec
...
```python tab="Python" title="删除列" tab-group="code-demo"
...
```python tab="Python" title="修改列" tab-group="code-demo"
# 重命名
...
```python tab="Python" title="查看当前 Schema" tab-group="code-demo"
...
```python tab="Python" title="创建索引" tab-group="code-demo"
import zvec
...
```python tab="Python" title="删除索引" tab-group="code-demo"
