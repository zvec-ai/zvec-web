...
> 💡 For a more detailed quick-start, see [**Zvec QuickStart**](/en/docs/db/quickstart/).
>
...
> 💡 For more benchmark details, see [**Zvec Benchmark**](/en/docs/db/benchmarks/).
>
...
> 💡 More details are available in the [**Zvec Docs**](/en/docs/db/).
>
